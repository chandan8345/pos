							...
							<div class="col-xs-12">
                                <div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">Add Products </h4>
											</div>
...
"></i>
                                            ...
                                            @endforeach
                                                                      ...
                                                                      <span class="input-group-addon">
																		<i class="ace-icon 	fa fa-pie-chart	
"></i>
																	</span></div>
                                                                  </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                              <div class="col-lg-6">
                                                                  <div class="form-group">
                                                                    <label for="InputName">Purchase Rate</label>
                                                                    <div class="input-group">
                                                                      <input type="text" class="form-control" name="purchase" id="purchase" placeholder="Purchase Rate" required>
                                                                      <span class="input-group-addon">
                                                                ...
                                                                <div class="col-lg-6">
                                                                  <div class="form-group">
                                                                    <label for="InputName">Sales Rate</label>
                                                                    <div class="input-group">
                                                                      <input type="text" class="form-control" name="sell" id="sell" placeholder="Sales Rate" required>
                                                                      <span class="input-group-addon">
																		<i class="ace-icon fa fa-usd"></i>
																	</span></div>
                                                                  </div>
														...
														<div class="form-actions center">
															<button type="button" data-toggle="modal" data-target="#m" class="btn btn-md btn-success btn-block">
																Save
																<i class="ace-icon fa fa-database-right icon-on-left bigger-110"></i>
															</button>
														</div>
