						...
						<div class="nav-search" id="nav-search">
							<form class="form-search">
								<span class="input-icon">
                                    <input type="button" value="Add Category" class="btn btn-info btn-xs"  data-toggle="modal" data-target="#c">
                                    <i class="ace-icon fa fa-plus-circle"></i>
								</span>
                                <span class="input-icon">
                                    <input type="button" value="Add Brand" class="btn btn-warning btn-xs"  data-toggle="modal" data-target="#b">
                                    <i class="ace-icon fa fa-plus-circle"></i>
								</span>
							</form>
						</div><!-- /.nav-search -->
...
@include('layouts.theme')
                                 ...
                                 <table id="simple-table" class="table  table-bordered table-hover">
											...
											<tbody>
												...
												<span class="center">{{ $row->name }}</span>
													...
													<td class="center">
														<div class="btn-group">
															<a class="btn btn-sm btn-info"  data-toggle="modal" data-target="#<?php echo $row->id; ?>">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</a>
                                                            <a class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#category">
                                                                ...
                                                                <a href="{{ URL::to('CategoryDelete/' . $row->id) }}" class="btn btn-primary">
          ...
          <div class="modal-dialog" role="document">
           <div class="modal-content">
               <form action="{{ URL::to('/CategoryUpdate/'.$row->id) }}" method="post">
         ...
         <div class="modal-header">
          ...
          <div class="modal-body">
               <div class="row">
                   <div class="col-xs-12">
                    <input type="text" class="form-control" placeholder="Category Name" name="name" value="{{$row->name}}">
        ...
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
         ...
         Update
                                 ...
                                 <table id="simple-table" class="table  table-bordered table-hover">
											...
											<tbody>
												...
												<span class="center">{{ $row->name }}</span>
													...
													<td class="center">
														<div class="btn-group">
															<a href="" class="btn btn-sm btn-info"  data-toggle="modal" data-target="#<?php echo $row->id; ?>">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</a>
                                                            <a href="" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#brand">
                                                        ...
                                                        <div class="modal fade" id="brand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                 ...
                                                                 <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                                <a href="{{ URL::to('BrandDelete/' . $row->id) }}" class="btn btn-primary">
                                                                <i class="ace-icon fa fa-check align-top bigger-125">Confirm</i>
                                                                </a>
                                                              </div>
                                                            </div>
          ...
          <div class="modal-dialog" role="document">
           <div class="modal-content">
               <form action="{{ URL::to('/BrandUpdate/'.$row->id) }}" method="post">
                    <input type ="hidden" id="token" name="_token" value ="<?php echo csrf_token(); ?>">
         <div class="modal-header">
        ...
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
         ...
         Update
          ...
          <div class="modal-dialog" role="document">
           <div class="modal-content">
               <form action="{{ URL::to('/CreateCategory') }}" method="post">
                    <input type ="hidden" id="token" name="_token" value ="<?php echo csrf_token(); ?>">
         <div class="modal-header">
        ...
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
         ...
         Submit
          ...
          <div class="modal-dialog" role="document">
           <div class="modal-content">
               <form action="{{URL::to('/CreateBrand')}}" method="post">
            <input type ="hidden" id="token" name="_token" value ="<?php echo csrf_token(); ?>">
         <div class="modal-header">
