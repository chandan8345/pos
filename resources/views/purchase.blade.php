							...
							<div class="col-xs-12">
                                <div class="widget-box">
											<div class="widget-header widget-header-small">
												<h5 class="widget-title lighter">Purchase Form</h5>
											</div>
													...
													<input type ="hidden" id="token" name="_token" value ="<?php echo csrf_token(); ?>">
                                                        ...
                                                        <div class="col-xs-6 col-sm-6">
														   ...
														   <span class="input-icon btn-block">
                                                            ...
                                                            <div class="col-md-12">
                                                           <span class="input-icon btn-block">
                                                           <input type="button" id="pay" value="Payment" class="btn btn-danger btn-md btn-block"  data-toggle="modal" data-target="#payment">
                                                            </span>
														</div>
                                                            </div>
														</div>
...
@include('layouts.footer')
 ...
 <div class="modal" id="payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
               <div class="row">
                 <div class="col-sm-12">
                     <label><b>Supplier Name</b></label>
                       <input type="text" id="client" name="client" class="btn-block" autofocus>
                   </div>   
               </div>
                   <div class="space-4"></div>
              <div class="row">
                   <div class="col-sm-12">
                      ...
                      <input type="text" id="paid" name="paid" value="" class="btn-block paid">
                   </div>
            ...
            <div class="row">
                   <div class="col-sm-12">
                      ...
                      <input type="text" id="total" name="total" value="" class="btn-block"  disabled>
                   </div>
            ...
            <div class="row">
                   <div class="col-sm-12">
                      ...
                      <input type="text" id="dues" name="dues" value="" class="btn-block" disabled>
                   </div>
             ...
             <div class="row">
                   <div class="col-sm-12">
                      ...
                      <input type="text" id="balance" name="balance" value="" class="btn-block" disabled>
                   </div>
            ...
            <div class="row">
                   <div class="col-sm-12">
					   ...
					   <input type="text" id="date" name="date" value="{{date("d-m-Y")}}" class="form-control hasDatepicker">
                   </div>
            </div>
                <div class="space-4"></div>
            <div class="row">
                   <div class="col-sm-12">
                      ...
                      <input type="text" value="{{ Session::get('user_name') }}" class="btn-block" disabled>
             </div>
            </div>
        ...
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
         <button type="button" id="payment-submit" class="btn btn-primary">
         Submit
		 </button>
      </div>
...
<![endif]-->
  ...
  $( function() {
	...
	var availableT =  <?php echo json_encode($custom); ?>;
            $( "#client" ).autocomplete({
             source: availableT
              });
  });
...
function msg() {
    if($("#name").val() !="" && $("#quantity").val() !=""){
			...
			var unit=$("#unit").val();
			var tr='<tr> <td class="center">'+id+'</td> <td class="center">'+name+'</td> <td class="center">'+single+'</td> <td class="center td-q" contenteditable="true">'+quantity+'</td> <td class="center">'+payable+'</td>  <td class="center">'+unit+'</td><td class="center"> <button class="btn btn-sm btn-danger btn-del"><i class="ace-icon fa fa-trash-o"></i></button></td></tr>';
			$("tbody").append(tr);
			$("#category").val(0);
	        $("#brand").val(0);
		    $("#status").val("Status");
	...
	$(document).on("blur",'.td-q',function(){
		var _tr=$(this).closest("tr");
		var _quantity=$(_tr).find('td:eq(3)').text();
		var _single=$(_tr).find('td:eq(2)').text();
		var _total=_quantity*_single;
		$(_tr).find('td:eq(4)').text(_total);	
	});
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response){
											...
											var row=$('#tbody').find('tr').length;
                                                ...
                                                var amount = parseInt($(this).find('td:eq(4)').text());
												$.ajax({
														type: "POST",
                                        				url: '{{ URL::to("/Invoice") }}',
                                        				data:{
